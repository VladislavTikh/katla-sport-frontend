...
import { EmployeeListComponent } from './employee-managment/lists/employee-list.component';
import { EmployeeService } from './employee-managment/services/employee.service';
import { EmployeeFormComponent } from './employee-managment/forms/employee-form.component';
import { EmployeeSubordinatesListComponent } from './employee-managment/lists/employee-subordinates-list.component';
...
@NgModule({
  declarations: [
    ...
    EmployeeSubordinatesListComponent,
  ],
  imports: [
    // Angular imports
    BrowserModule,
